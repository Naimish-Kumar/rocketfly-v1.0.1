import 'models/payment_method_g_pay_model.dart';
...
import 'provider/payment_method_g_pay_provider.dart';

class PaymentMethodGPayScreen extends StatefulWidget {
  const PaymentMethodGPayScreen({Key? key}) : super(key: key);

  @override
  PaymentMethodGPayScreenState createState() => PaymentMethodGPayScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PaymentMethodGPayProvider(),
        child: PaymentMethodGPayScreen());
  }
}

// ignore_for_file: must_be_immutable
class PaymentMethodGPayScreenState extends State<PaymentMethodGPayScreen>
