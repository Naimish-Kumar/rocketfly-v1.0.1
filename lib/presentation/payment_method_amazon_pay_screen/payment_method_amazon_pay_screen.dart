import 'models/payment_method_amazon_pay_model.dart';
...
import 'provider/payment_method_amazon_pay_provider.dart';

class PaymentMethodAmazonPayScreen extends StatefulWidget {
  const PaymentMethodAmazonPayScreen({Key? key}) : super(key: key);

  @override
  PaymentMethodAmazonPayScreenState createState() =>
      PaymentMethodAmazonPayScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PaymentMethodAmazonPayProvider(),
        child: PaymentMethodAmazonPayScreen());
  }
}

// ignore_for_file: must_be_immutable
class PaymentMethodAmazonPayScreenState
    extends State<PaymentMethodAmazonPayScreen> with TickerProviderStateMixin {
