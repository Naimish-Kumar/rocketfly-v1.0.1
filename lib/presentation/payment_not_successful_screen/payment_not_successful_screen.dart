...
import 'provider/payment_not_successful_provider.dart';

class PaymentNotSuccessfulScreen extends StatefulWidget {
  const PaymentNotSuccessfulScreen({Key? key}) : super(key: key);

  @override
  PaymentNotSuccessfulScreenState createState() =>
      PaymentNotSuccessfulScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => PaymentNotSuccessfulProvider(),
        child: PaymentNotSuccessfulScreen());
  }
}

class PaymentNotSuccessfulScreenState
    extends State<PaymentNotSuccessfulScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildImagePlaceHolder(BuildContext context) {
    return Container(
        padding: EdgeInsets.symmetric(horizontal: 21.h, vertical: 152.v),
