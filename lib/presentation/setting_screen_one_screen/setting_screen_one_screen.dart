...
import 'provider/setting_screen_one_provider.dart';

class SettingScreenOneScreen extends StatefulWidget {
  const SettingScreenOneScreen({Key? key}) : super(key: key);

  @override
  SettingScreenOneScreenState createState() => SettingScreenOneScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SettingScreenOneProvider(),
        child: SettingScreenOneScreen());
  }
}

class SettingScreenOneScreenState extends State<SettingScreenOneScreen> {
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Scaffold(
                          ...
                          child: Padding(
                              ...
                              child: Column(children: [
                                _buildNotification(context,
                                    userIcon: ImageConstant.imgIcon38,
                                    notificationText: "lbl_payment".tr),
                                SizedBox(height: 8.v),
                                Container(
                                    padding:
                                    ...
                                    child: Column(children: [
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon39,
                                          notificationText:
                                              "lbl_notification".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon40,
                                          notificationText: "lbl_language".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon41,
                                          notificationText: "lbl_currency".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon42,
                                          notificationText: "lbl_about_us".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon43,
                                          notificationText:
                                              "lbl_privacy_policy".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon44,
                                          notificationText: "lbl_faqs".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon45,
                                          notificationText:
                                              "lbl_send_feedback".tr),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon46,
                                          notificationText: "lbl_rate_us".tr),
                                      SizedBox(height: 17.v),
                                      _buildDarkMode(context),
                                      SizedBox(height: 17.v),
                                      _buildNotification(context,
                                          userIcon: ImageConstant.imgIcon48,
                                          notificationText:
            ...
            bottomNavigationBar: Padding(
                ...
                child: _buildNotification(context,
                    userIcon: ImageConstant.imgIcon49,
                    notificationText: "lbl_logout".tr))));
  }
  ...
  Widget _buildDarkMode(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Spacer(),
      Selector<SettingScreenOneProvider, bool?>(
    ...
    return SizedBox(
        ...
        child: Stack(alignment: Alignment.center, children: [
          CustomImageView(
              ...
              alignment: Alignment.center),
          CustomImageView(
              imagePath: ImageConstant.imgIcon47,
              height: 24.adaptSize,
              width: 24.adaptSize,
              alignment: Alignment.center)
        ]));
