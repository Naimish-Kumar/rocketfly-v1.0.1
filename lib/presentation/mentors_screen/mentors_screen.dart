import '../mentors_screen/widgets/following_item_widget.dart';
...
import 'provider/mentors_provider.dart';
...
class MentorsScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MentorsProvider(), child: MentorsScreen());
  }
}
            ...
            body: Padding(
                ...
                child: Consumer<MentorsProvider>(
                  ...
                  return ListView.separated(
                      ...
                      itemCount:
                          provider.mentorsModelObj.followingItemList.length,
                      itemBuilder: (context, index) {
                        FollowingItemModel model =
                            provider.mentorsModelObj.followingItemList[index];
          ...
          Padding(
              ...
              child: Row(children: [
                ...
                AppbarSubtitle(
                    text: "lbl_mentors".tr,
                    margin:
                        EdgeInsets.only(left: 114.h, top: 1.v, bottom: 3.v)),
                AppbarTitleImage(
