import '../search_screen/widgets/crmmanagementlist_item_widget.dart';
...
class SearchScreenState extends State<SearchScreen> {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  SizedBox(height: 9.v),
                  _buildCrmManagementList(context)
                ]))));
  }
  ...
  /// Section Widget
  Widget _buildCrmManagementList(BuildContext context) {
    return Consumer<SearchProvider>(builder: (context, provider, child) {
      return ListView.separated(
          ...
          itemCount: provider.searchModelObj.crmmanagementlistItemList.length,
          itemBuilder: (context, index) {
            CrmmanagementlistItemModel model =
                provider.searchModelObj.crmmanagementlistItemList[index];
            return CrmmanagementlistItemWidget(model);
          });
    });
  }
