...
import 'provider/subscription_successful_provider.dart';

class SubscriptionSuccessfulScreen extends StatefulWidget {
  const SubscriptionSuccessfulScreen({Key? key}) : super(key: key);

  @override
  SubscriptionSuccessfulScreenState createState() =>
      SubscriptionSuccessfulScreenState();
...
class SubscriptionSuccessfulScreenState
  ...
  /// Section Widget
  Widget _buildGoToCourse(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_go_to_course".tr,
